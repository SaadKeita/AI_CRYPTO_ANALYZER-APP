...
export default function InvestmentCalculator({ cryptoData, onSelectCrypto }: Props) {
  ...
  return (
    <div className="space-y-8">
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-purple-500/20 shadow-xl">
        <div className="text-purple-100 font-semibold mb-4 flex items-center">
          <AlertTriangle className="w-5 h-5 mr-2 text-purple-300" />
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-purple-500/20 shadow-xl">
        <div className="space-y-6">
          <div>
            ...
            <select
              className="w-full bg-purple-900/50 border border-purple-500/30 rounded-lg px-4 py-3 text-purple-100 focus:outline-none focus:border-purple-400 transition-colors"
              onChange={(e) => {
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {prediction && (
          <div className="mt-8 space-y-4">
            <div className="p-6 rounded-lg bg-gradient-to-r from-purple-900/50 to-blue-900/50 border border-purple-500/20">
              <h3 className="text-lg font-semibold text-purple-100 mb-4">Investment Analysis</h3>
              
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-purple-200">Potential Return:</span>
