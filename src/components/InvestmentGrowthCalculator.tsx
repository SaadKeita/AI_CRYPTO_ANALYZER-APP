...
export default function InvestmentGrowthCalculator({ cryptoData, onSelectCrypto }: Props) {
    ...
    <div className="bg-navy-900/50 backdrop-blur-lg rounded-xl p-6 border border-purple-500/20 shadow-xl">
      <div className="space-y-6">
        <div>
          ...
          <select
            className="w-full bg-navy-800/50 border border-purple-500/30 rounded-lg px-4 py-3 text-white/90 focus:outline-none focus:border-purple-400 transition-colors"
            onChange={(e) => {
          ...
          >
            ...
            {cryptoData.map((crypto) => (
              <option key={crypto.id} value={crypto.id} className="bg-navy-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-white/90 mb-2">
              <DollarSign className="w-4 h-4 inline-block mr-1 text-purple-400" />
          ...
          <div>
            <label className="block text-sm font-medium text-white/90 mb-2">
              <Clock className="w-4 h-4 inline-block mr-1 text-purple-400" />
      ...
      {prediction && (
        <div className="mt-8">
          <div className="p-6 rounded-lg bg-gradient-to-r from-navy-800/30 to-purple-900/30 border border-purple-500/20 backdrop-blur-lg">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-white/90">Potential Return:</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-white/90">Confidence Score:</span>
